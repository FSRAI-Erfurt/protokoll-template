...
% If less than 50% of the members are present, the meeting is not quorate
%
% Usage:
% \quorum
\newcommand{\quorum}{
...
% \approveTO
% Print the approval of the TO
% 
% Usage:
% \approveTO{NUMBER_OF_APPROVALS}
\newcommand{\approveTO}[1]{
  Die vorliegende Tagesordnung wird mit \textbf{#1 von \meetingAttendence} stimmberechtigten FsR-Mitgliedern beschlossen.
}

% Print TO Apporval with Changed TO
%
% Usage:
% \approveTOwithChange{NUMBER_OF_APPROVALS}{CHANGED_POINTS}
\newcommand{\approveTOwithChange}[2]{
  Die vorliegende Tagesordnung wird mit \textbf{#1 von \meetingAttendence} stimmberechtigten FsR-Mitgliedern beschlossen. 
